    ...
    <section id="home" className="introduction-container" ref={ref}>
      <Container>
        <div className="introduction">
          ...
          >
            <span className="bold">Hi there! I'm Anthony Massaad</span>, a{" "}
            <span className="bold">Software Engineering graduate</span> at
            Carleton University.{" "}
            <span className="bold">
          ...
          >
            <div>
              ...
              <Button to={externalLinks.resume} newTab>
                View Resume <HiArrowRight />
              </Button>
            </div>
            <div>
